...
<body>
    ...
    <div class="items">
        <div class="item-text">
            <h1>Televisions</h1>
            <p>Here at Gabby's, we recognize the value of prized possessions and have created a more convenient way people can pawn. We achieve this by leveraging technology already available to most people. We streamline everything: from having your item appraised, to getting the item to us, and getting the cash right in your bank account. We offer the highest appraisal prices. </p>
            <br> <br>
            <p>Interested to pawn your TV? Pawn here now!</p>
        </div>
